...
export default function About() {
  ...
  const [visibleChars, setVisibleChars] =
    useState(0);
  const terminalLines = [
    `const engineer = {`,
    `  name: "${t.terminalCard.name}",`,
    `  role: "${t.terminalCard.role}",`,
    `  location: "${t.terminalCard.location}",`,
    `  education: "${t.terminalCard.education}",`,
    `};`,
    ``,
    `engineer.build();`,
  ];
