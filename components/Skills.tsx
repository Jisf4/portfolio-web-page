          ...
          {t.skills.map((skill, index) => (
            ...
            >
              ...
              <Image
                ...
                width={60}
                height={60}
                className="object-contain mx-auto w-12 h-12 rounded-2xl p-1 shadow-lg shadow-slate-200/50 dark:shadow-white/20 bg-white dark:bg-slate-200 border border-slate-300"
              />
              {/* NAME */}
